...
public class QuantityMeasurementServiceImpl
    ...
    /**
     * Helper method to save a successful operation to the repository
     */
    private void saveOperation(String operation, String operand1, String operand2, String result) {
        try {
    ...
    /**
     */
    private void saveError(String operation, String error) {
        try {
            QuantityMeasurementEntity entity = new QuantityMeasurementEntity(
                    operation, error);
            repository.save(entity);
